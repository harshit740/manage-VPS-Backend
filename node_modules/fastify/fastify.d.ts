...
declare function fastify<HttpServer extends (http.Server | http2.Http2Server) = http.Server,
    HttpRequest extends (http.IncomingMessage | http2.Http2ServerRequest) = http.IncomingMessage,
    HttpResponse extends (http.ServerResponse | http2.Http2ServerResponse) = http.ServerResponse>(opts?: fastify.ServerOptions): fastify.FastifyInstance<HttpServer, HttpRequest, HttpResponse>;
...
declare namespace fastify {
    ...
    type FastifyMiddleware<HttpServer = http.Server,
    ...
    type FastifyMiddlewareWithPayload<HttpServer = http.Server,
        HttpRequest = http.IncomingMessage,
        HttpResponse = http.ServerResponse,
        Query = DefaultQuery,
        Params = DefaultParams,
    ...
    type RequestHandler<HttpRequest = http.IncomingMessage,
        HttpResponse = http.ServerResponse,
        Query = DefaultQuery,
        Params = DefaultParams,
        Headers = DefaultHeaders,
     ...
     */
    interface RouteShorthandOptions<HttpServer = http.Server,
        HttpRequest = http.IncomingMessage,
        HttpResponse = http.ServerResponse,
        Query = DefaultQuery,
        Params = DefaultParams,
     ...
     */
    interface RouteOptions<HttpServer = http.Server,
        HttpRequest = http.IncomingMessage,
        HttpResponse = http.ServerResponse,
        Query = DefaultQuery,
        Params = DefaultParams,
        Headers = DefaultHeaders,
        Body = DefaultBody> extends RouteShorthandOptions<HttpServer, HttpRequest, HttpResponse, Query, Params, Headers, Body> {
